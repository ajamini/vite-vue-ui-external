...
<template>
  <div class="w-full bg-white">
    ...
    <div class="w-full">
      <div class="flex shadow-lg pl-12 relative">
        <div
          class="px-6 py-2 text-sm font-medium text-gray-500 relative cursor-pointer"
        ...
        <div class="absolute right-1/4 top-4">
          <!-- Rounded button for copy link -->
            ...
            <div class="w-full md:w-1/4 min-h-[420px] bg-white mt-6">
              ...
              <div class="text-gray-600 p-4">
                ...
                <div class="flex items-center gap-2 mt-2 ml-4">
                  <div class="w-10 h-10 rounded-full bg-gray-300">
                    <img
                      class="w-full rounded-full bg-cover"
